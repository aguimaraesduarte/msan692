...
dense_matrix = matrix.todense() #each row is a doc, each col is a word
myRow = dense_matrix[file_index]
word_indices = myRow.nonzero()[1]

tfidf = [(vectorizer.get_feature_names()[i], myRow[0, i]) for i in word_indices if myRow[0, i] >= 0.09]
